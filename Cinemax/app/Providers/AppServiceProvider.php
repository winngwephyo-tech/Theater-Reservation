...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function register()
    {
        ...
        $this->app->bind('App\Contracts\Dao\Movie\MovieDescriptionDaoInterface', 'App\Dao\Movie\MovieDescriptionDao');
        ...
        $this->app->bind('App\Contracts\Services\Movie\MovieDescriptionServiceInterface', 'App\Services\Movie\MovieDescriptionService');
